...
console.log(game);
  ...
  const platforms = game.platforms?.map((platform) => platform.name).join(", ") || "N/A";
  ...
  return (
    <GameContainer>
      ...
      <PlayingButton>Playing Now</PlayingButton>
      </ButtonsContainer>
      <GameInfo>
      <p><StyledDescripton>Platforms:</StyledDescripton> {platforms}</p>
      <p><StyledDescripton>Developer:</StyledDescripton> {developerCompany || "N/A"}</p>
      <p>
      <StyledDescripton>Release Date:</StyledDescripton> {new Date(game.first_release_date * 1000).toDateString()}
      </p>
      <p><StyledDescripton>Genres:</StyledDescripton> {genres}</p>
      <p><StyledDescripton>Rating:</StyledDescripton> {game.total_rating || "N/A"}</p>
...
const StyledDescripton = styled.p`
font-size: 1.3rem;
color: gray;
font-weight: 600;
